    ...
    `);
        ...
        for (const school of schools) {
         ...
         VALUES ($1, 0, 5, 3, 'AUTOMATICO')`, [school.id]);
            ...
            const rectorRes = await client.query(`INSERT INTO usuario (email, password, nombre, apellido, id_colegio, activo, estado)
         VALUES ($1, $2, $3, $4, $5, true, 'ACTIVO') RETURNING id_usuario`, [rectorEmail, directivoHash, "Rector", school.nombre, school.id]);
            ...
            const directivoResult = await client.query(`INSERT INTO usuario (email, password, nombre, apellido, id_colegio, activo, estado)
         VALUES ($1, $2, $3, $4, $5, true, 'ACTIVO') RETURNING id_usuario`, [directivoEmail, directivoHash, "Directivo", school.nombre, school.id]);
