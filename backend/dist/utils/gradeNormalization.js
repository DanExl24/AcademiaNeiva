...
exports.normalizeGradeName = normalizeGradeName;
exports.isDuplicateOrSimilarGrade = isDuplicateOrSimilarGrade;
/**
 ...
 */
function normalizeGradeName(str) {
 ...
 */
function isDuplicateOrSimilarGrade(name1, name2) {
