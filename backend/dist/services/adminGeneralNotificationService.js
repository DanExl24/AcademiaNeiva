...
exports.AdminGeneralNotificationService = void 0;
 ...
 * - Colegio suspendido
 */
class AdminGeneralNotificationService {
    ...
    // ─────────────────────────────────────────────────────────────
    static async sendSupervisionSolicitada(to, directivoNombre, adminNombre, colegioNombre, motivo, tipoSupervision) {
        if (!to)
            return;
        const html = `
    ...
    // SUPERVISIÓN: Aprobada
    // ─────────────────────────────────────────────────────────────
    static async sendSupervisionAprobada(to, adminNombre, colegioNombre, directivoNombre, tipoSupervision, duracionMinutos) {
        if (!to)
            return;
        const html = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937;">
    ...
    // SUPERVISIÓN: Rechazada / Revocada
    // ─────────────────────────────────────────────────────────────
    static async sendSupervisionRechazada(to, adminNombre, colegioNombre, directivoNombre, motivo) {
        if (!to)
            return;
        const html = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937;">
    ...
    // ─────────────────────────────────────────────────────────────
    static async sendSupervisionIniciada(to, directivoNombre, adminNombre, colegioNombre, tipoSupervision) {
        if (!to)
            return;
        const html = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937;">
    ...
    // ─────────────────────────────────────────────────────────────
    static async sendSupervisionFinalizada(to, directivoNombre, adminNombre, colegioNombre, duracionReal, totalAcciones) {
        if (!to)
            return;
        const html = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937;">
    ...
    // ─────────────────────────────────────────────────────────────
    static async sendColegioSuspendido(to, directivoNombre, colegioNombre, motivo) {
        if (!to)
            return;
        const html = `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 640px; margin: 0 auto; padding: 20px; color: #1f2937;">
...
exports.AdminGeneralNotificationService = AdminGeneralNotificationService;
