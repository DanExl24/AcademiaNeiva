      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #1f2937;">
        ...
        <div style="padding: 0 10px;">
          ...
          <div style="background-color: #f9fafb; border-radius: 16px; padding: 25px; margin: 30px 0; border: 1px solid #f3f4f6;">
            ...
            <h2 style="font-size: 16px; color: #4b5563; margin-top: 0; text-transform: uppercase; letter-spacing: 0.05em;">Credenciales de acceso</h2>
            ...
            <div style="margin-top: 20px; font-size: 13px; color: #9ca3af;">* Te recomendamos cambiar tu contraseña al primer ingreso. El código estudiantil es único y personal.</div>
          </div>
