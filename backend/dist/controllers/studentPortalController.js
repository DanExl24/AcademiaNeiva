...
exports.getStudentIdByUserId = exports.getParentDashboardData = exports.getStudentObservations = exports.getStudentAttendance = exports.getParentChildren = exports.getStudentInfo = exports.getGradeDetails = exports.getStudentGrades = exports.getStudentClosedPeriods = exports.getStudentAcademicYears = void 0;
...
exports.getStudentAcademicYears = getStudentAcademicYears;
/**
...
exports.getStudentClosedPeriods = getStudentClosedPeriods;
/**
...
const getGradeDetails = async (req, res) => {
    ...
    try {
        ...
        const materiaIdInt = parseInt(id_materia);
...
exports.getGradeDetails = getGradeDetails;
/**
...
const getParentDashboardData = async (req, res) => {
    ...
    `, [id_colegio]);
      ...
      `, [child.id_estudiante, id_periodo, child.id_grupo]);
            ...
            const attRes = await db_1.pool.query(`
        SELECT 
...
exports.getParentDashboardData = getParentDashboardData;
/**
...
exports.getStudentIdByUserId = getStudentIdByUserId;
