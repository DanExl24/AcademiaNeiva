...
const getStudentSummary = async (req, res) => {
    ...
    `, [id]);
        ...
        const decisionsRes = await db_1.pool.query(`SELECT dpd.id_decision, dpd.resultado_calculado, dpd.decision_tomada, dpd.fecha_decision, dpd.observacion,
       ...
       ORDER BY dpd.fecha_decision DESC`, [id]);
        res.json({
