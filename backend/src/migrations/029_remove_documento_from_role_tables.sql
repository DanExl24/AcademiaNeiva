...
BEGIN
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE docente DROP COLUMN documento;';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE docente DROP COLUMN id_tipodocumento;';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE padre_familia DROP COLUMN documento;';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE padre_familia DROP COLUMN id_tipodocumento;';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE estudiante DROP COLUMN documento;';
    END IF;
    ...
    IF EXISTS (
        ...
        EXECUTE 'ALTER TABLE estudiante DROP COLUMN id_tipodocumento;';
    END IF;
END $$;
