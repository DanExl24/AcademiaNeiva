  ...
  <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
    ...
    <div v-if="academicData && !fetchingGrades" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-500">
      ...
      <div class="hidden lg:flex bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm items-center justify-between group hover:shadow-lg transition-all duration-300">
        <div>
          <p class="text-xs font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Estado Académico</p>
          <p class="text-2xl font-black mt-1 text-slate-800 dark:text-white">Al día</p>
        </div>
            ...
            >
              ...
              <td class="px-8 py-6">
                <div class="flex justify-center">
                  <div 
                    class="h-12 w-12 rounded-2xl flex items-center justify-center text-lg font-black"
                    :class="item.calificacion < 3.0 ? 'bg-rose-100 text-rose-700 dark:bg-rose-950/40 dark:text-rose-400' : 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200'"
                  >
                    {{ item.calificacion }}
                  </div>
                </div>
